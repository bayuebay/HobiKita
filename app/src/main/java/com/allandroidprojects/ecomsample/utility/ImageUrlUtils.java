...
public class ImageUrlUtils {
    ...
    public static String[] getElectronicsUrls() {
        String[] urls = new String[]{
                "http://www.liburananak.com/images/events/image_large_549ca1c292909_Kemah-Gasing-(2)-2.jpg",
                "https://4.bp.blogspot.com/-g-sAndnMavw/VzKC9T5toiI/AAAAAAAABZU/AEZnQYwk_RMeaXYXl3LNc_5jYeKrAJYVQCLcB/s400/1459401649059.jpg",
        };
        return urls;
    }
    ...
    public static String[] getLifeStyleUrls() {
        String[] urls = new String[]{
                "https://www.jakartanotebook.com/images/products/80/63/17116/6/double-layer-door-camping-tent-or-tenda-camping-blue-484.JPG",
                "https://moedah.com/wp-content/uploads/2015/08/KOMPOR-KEMAH-3-1024x768.jp"
        };
        return urls;
    }
